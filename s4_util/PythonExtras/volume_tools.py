...
@deprecated("Use VolumeMetadata class instead.")
...
@deprecated("Use 'load_volume_from_dat instead")
...
def write_volume_sequence(outputPath: str,
    ...
    metaPath = str(outputPath.with_suffix('.dat'))
    dataPath = str(outputPath.parent / outputPath.stem)  # Without the extension.
    basePath = str(outputPath.parent)
...
def write_volume_to_datraw(data: npe.LargeArray, rawOrDatPath: str, dataOrder: str = 'zyx',
    ...
    #assert data.dtype == np.uint8  # why?
